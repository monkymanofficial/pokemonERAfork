const struct PokedexEntry gPokedexEntries[] =
{
    ...
    [NATIONAL_DEX_MEOWSHROOM] =
    {
        .categoryName = _("Shroom"),
        .height = 7,
        .weight = 69,
        .description = gMeowshroomPokedexText,
        .pokemonScale = 356,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_FELIFUNGI] =
    {
        .categoryName = _("Shroom"),
        .height = 10,
        .weight = 130,
        .description = gFelifungiPokedexText,
        .pokemonScale = 335,
        .pokemonOffset = 13,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_GARFUNGUS] =
    {
        .categoryName = _("Mycelium"),
        .height = 20,
        .weight = 1000,
        .description = gGarfungusPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 0,
        .trainerScale = 388,
        .trainerOffset = 6,
    ...
    [NATIONAL_DEX_RIZARD] =
    {
        ...
        .height = 6,
        .weight = 85,
        .description = gRizardPokedexText,
        .pokemonScale = 444,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_RUCKAGON] =
    {
        .categoryName = _("Fortune"),
        .height = 11,
        .weight = 190,
        .description = gRuckagonPokedexText,
        .pokemonScale = 302,
        .pokemonOffset = 9,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CHINGLONG] =
    {
        .categoryName = _("Social Credit"),
        .height = 17,
        .weight = 905,
        .description = gChinglongPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = 1,
        .trainerScale = 302,
        .trainerOffset = 3,
    ...
    [NATIONAL_DEX_HIPALOON] =
    {
        .categoryName = _("Hippo"),
        .height = 5,
        .weight = 90,
        .description = gHipaloonPokedexText,
        .pokemonScale = 412,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_CRATOE] =
    {
        .categoryName = _("Heavy Hippo"),
        .height = 10,
        .weight = 225,
        .description = gCratoePokedexText,
        .pokemonScale = 332,
        .pokemonOffset = 10,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HIPPOBESE] =
    {
        .categoryName = _("Obese"),
        .height = 16,
        .weight = 855,
        .description = gHipobesityPokedexText,
        .pokemonScale = 256,
        .pokemonOffset = -1,
        .trainerScale = 293,
        .trainerOffset = 2,
    ...
    [NATIONAL_DEX_RAGEJIN] =
    {
        .categoryName = _("Rocker"),
        .height = 3,
        .weight = 29,
        .description = gRagejinPokedexText,
        .pokemonScale = 549,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_TUNDASTRUK] =
    {
        .categoryName = _("Drummer"),
        .height = 7,
        .weight = 99,
        .description = gTundastrukPokedexText,
        .pokemonScale = 350,
        .pokemonOffset = 18,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_BRILECTRIC] =
    {
        .categoryName = _("Thunder Oni"),
        .height = 11,
        .weight = 320,
        .description = gBrilectricPokedexText,
        .pokemonScale = 312,
        .pokemonOffset = 2,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_Boobird] =
    {
        .categoryName = _("Gawking"),
        .height = 3,
        .weight = 32,
        .description = gBoobirdPokedexText,
        .pokemonScale = 455,
        .pokemonOffset = 22,
        .trainerScale = 256,
        .trainerOffset = 0,
    ...
    [NATIONAL_DEX_HOONKAH] =
    {
        .categoryName = _("Cocoon"),
        .height = 6,
        .weight = 100,
        .description = gHoonkahPokedexText,
        .pokemonScale = 424,
        .pokemonOffset = 17,
        .trainerScale = 256,
        .trainerOffset = 0,
