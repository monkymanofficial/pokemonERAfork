...
static const struct LevelUpMove sMeowshroomLevelUpLearnset[] = {
...
static const struct LevelUpMove sFelifungiLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
...
static const struct LevelUpMove sGarfungusLevelUpLearnset[] = {
    ...
    LEVEL_UP_MOVE(66, MOVE_PURIFY),
    LEVEL_UP_END    LEVEL_UP_END
};

static const struct LevelUpMove sRizardLevelUpLearnset[] = {
...
static const struct LevelUpMove sRuckagonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_SCRATCH),
...
static const struct LevelUpMove sChinglongLevelUpLearnset[] = {
...
static const struct LevelUpMove sHipaloonLevelUpLearnset[] = {
    LEVEL_UP_MOVE( 1, MOVE_TACKLE),
