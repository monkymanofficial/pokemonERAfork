...
{
    [SPECIES_MEOWSHROOM]            = {{EVO_LEVEL, 16, SPECIES_FELIFUNGI}},
    [SPECIES_FELIFUNGI]             = {{EVO_LEVEL, 36, SPECIES_GARFUNGUS}},
    [SPECIES_RIZARD]                = {{EVO_LEVEL, 15, SPECIES_RUCKAGON}},
    [SPECIES_RUCKAGON]              = {{EVO_LEVEL, 37, SPECIES_CHINGLONG}},
    [SPECIES_HIPALOON]              = {{EVO_LEVEL, 17, SPECIES_CRATOE}},
    [SPECIES_CRATOE]                = {{EVO_LEVEL, 35, SPECIES_HIPPOBESE}},
    [SPECIES_RAGEJIN]              = {{EVO_LEVEL, 18, SPECIES_TUNDASTRUK}},
    [SPECIES_TUNDASTRUK]               = {{EVO_LEVEL, 38, SPECIES_BRILECTRIC}},
    [SPECIES_BOOBIRD]                = {{EVO_LEVEL, 17, SPECIES_HOONKAH}},
    [SPECIES_HOONKAH]                = {{EVO_LEVEL, 32, SPECIES_AWOOGANS}},
